...
CWD="/mnt/vipdata/Documents/TestReprojection/"
DirLandsat="${CWD}LANDSAT_RESAMPLED/${Sensor1}/STATS_${OutputRes}/${Tile}/"
DirMODIS="${CWD}MODIS_RESAMPLED/${Sensor2}/STATS_${OutputRes}/${Tile}/"
InputDirs="${DirLandsat},${DirMODIS}"
OutputDir="${CWD}LANDSAT/TIME_SERIES/"

Datasets="NDVI,EVI,EVI2"
Patterns=".A2000" #,.A2001,.A2002,.A2006"
